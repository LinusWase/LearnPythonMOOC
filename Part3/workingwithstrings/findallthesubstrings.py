...
characters long, and which begin with the character specified by the user. You may assume the input string is at least
...
while len(input_string) - counter >= 0:
    if input_char == input_string[0] and len(input_string) >= 3:
