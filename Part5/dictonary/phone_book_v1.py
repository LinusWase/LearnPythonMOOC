...
As you can see above, each name can be attached to a single number only. If a new entry with the same name is added,
...
while True:
    ...
    if user_input == 3:
        ...
        name = input("name: ")
        number = input("number: ")
        name_dictionary[name] = number
        print("ok!")
    elif user_input == 1:
        search_name = input("name: ")
        if search_name in name_dictionary:
            print(name_dictionary[search_name])
        else:
            print("no number")
