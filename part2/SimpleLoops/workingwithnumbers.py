...
Please write a program which asks the user for integer numbers. The program should keep asking for numbers until the
user types in zero.
Sample output
...
After reading in the numbers the program should print out how many numbers were typed in. The zero at the end should
...
The program should also print out the sum of all the numbers typed in. The zero at the end should not be included in
the calculation.
...
print(f"The mean of the numbers is {total_sum / counter}")
print(f"Positive numbers {positive_numbers}")
print(f"Negative numbers {counter - positive_numbers}")